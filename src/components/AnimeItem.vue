<template>
	<div class="anime-card">
		<expandable-image v-bind:src="anime.image_url" alt="Poster" close-on-background-click />
		<div class="overlay">
			<v-tooltip left>
		...
		<img
			...
			@click="openMALUrl()"
		/>
		<img class="rating-shiba header-icon" :src="this.getShibaRating()" v-bind:alt="this.anime.score" />
